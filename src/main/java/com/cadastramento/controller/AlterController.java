...
public class AlterController {
	...
	void atualizarButtonOnAction(ActionEvent event) {
		...
		if (FormUtil.isValid(nomeTextField, cpfTextField, cidadeTextField, estadoChoiceBox)) {
			...
			incluirStatusLabel.setText("Atualizando pessoa física . . . ");
	...
	public void initialize() {
		...
		TextFieldValidator.addListener(nomeTextField, "^[A-z àáâãéêìíóôõúçÀÁÂÃÉÊÍÒÓÔÇ]{5,}$");
		...
		TextFieldValidator.addListener(cidadeTextField, "^[A-z àáâãéêìíóôõúçÀÁÂÃÉÊÍÒÓÔÇ]+$");
